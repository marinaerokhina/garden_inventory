...
Проект разработан на основе курсовой работы по предмету "Базы данных". Документация оригинальной курсовой работы доступна в файле `КР-Ерохина.pdf`. Огригинальна КР
выполнялась на PostgreSQL.

---

**Автор:** Марина Ерохина  
**Дата:** Декабрь 2025  
**Университет:** Курсовая работа по базам данных
